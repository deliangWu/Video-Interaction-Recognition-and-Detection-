...
def main(argv):
    ...
    with tf.variable_scope('top') as scope:
        if len(argv) >= 3 and argv[2] == 'ShareFeatureVariable':
            ...
            c3d = network.C3DNET_2F1C(numOfClasses, frmSize,nof_conv1=32, nof_conv2=128, nof_conv3=256, nof_conv4=512,noo_fc6=4096,noo_fc7=2048)
            ...
            c3d = network.C3DNET_2F1C(numOfClasses, frmSize, nof_conv1=32, nof_conv2=128, nof_conv3=256, nof_conv4=512,noo_fc6=4096,noo_fc7=2048, shareFeatureVariable= False)
            saver_feature_a0 = tf.train.Saver([tf.get_default_graph().get_tensor_by_name(varName) for varName in common.Vars.feature_a0_VarsList])
