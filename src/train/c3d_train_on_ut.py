...
def main(argv):
    ...
    with tf.variable_scope('top') as scope:
        c3d = network.C3DNET(numOfClasses, frmSize,nof_conv1=32, nof_conv2= 128, nof_conv3=256, nof_conv4= 512, noo_fc6=2018, noo_fc7=2048)
    # ***********************************************************
    # define session
    # ***********************************************************
        ...
        for seq in seqRange:
            ...
            if len(argv) < 2 or argv[1] == 'train' or argv[1] == 'Train':
                ...
                while True:
                    ...
                    learning_rate = 0.0001 * 2**(-int(epoch/12))
                    ...
                    if i%int(iteration/50) == 0:
                        ...
                        if test_accuracy == 1 or epoch >= 60:
                            break
                    i+=1
