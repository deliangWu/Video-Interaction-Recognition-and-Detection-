...
class FeatureDescriptor:
    ...
    def c3d(x,frmSize,drop_var, nof_conv1 = 64, nof_conv2 = 128, nof_conv3 = 256, nof_conv4 = 256, noo_fc6 = 4096, noo_fc7 = 4096):
        ...
        with tf.variable_scope('conv1'):
            ...
            W_conv1 = weight_variable([3,4,4,frmSize[2],numOfFilters_conv1])
        ...
        with tf.variable_scope('conv2'):
            ...
            W_conv2 = weight_variable([3,4,4,numOfFilters_conv1,numOfFilters_conv2])
        ...
        with tf.variable_scope('conv3a'):
            ...
            W_conv3a = weight_variable([3,4,4,numOfFilters_conv2,numOfFilters_conv3])
        ...
        with tf.variable_scope('conv4a'):
            ...
            W_conv4a = weight_variable([3,4,4,numOfFilters_conv3,numOfFilters_conv4])
