    ...
    def c3d(x,frmSize,drop_var, nof_conv1 = 64, nof_conv2 = 128, nof_conv3 = 256, nof_conv4 = 256, noo_fc6 = 4096, noo_fc7 = 4096):
        with tf.device(common.Vars.dev[0]):
            ...
            with tf.variable_scope('conv3b'):
                W_conv3b = weight_variable([3,3,3,numOfFilters_conv3,numOfFilters_conv3])
                b_conv3b = bias_variable([numOfFilters_conv3])
            ...
            with tf.variable_scope('fc6'):
                ...
                h_pool4_flat = tf.reshape(h_pool5, [-1, int(frmSize[0]/16 * frmSize[1]/16) * numOfFilters_conv5])
